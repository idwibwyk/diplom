        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link to="/book/service" className="hover:text-[#4A90E2] transition-colors">Записаться на услугу</Link></li>
              <li><Link to="/services/blog" className="hover:text-[#4A90E2] transition-colors">Блог</Link></li>
              <li><Link to="/services/shelters" className="hover:text-[#4A90E2] transition-colors">Приюты</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-lg mb-4">MARS GROOM — Курсы</h4>
            <ul className="space-y-2 text-gray-400">
              <li><Link to="/courses" className="hover:text-[#4A90E2] transition-colors">Главная</Link></li>
              ...
              <li><Link to="/courses/blog" className="hover:text-[#4A90E2] transition-colors">Блог</Link></li>
              <li><Link to="/licenses" className="hover:text-[#40AB40] transition-colors">Сведения об организации</Link></li>
              <li><Link to="/courses/zone-rental" className="hover:text-[#4A90E2] transition-colors">Аренда зоны</Link></li>
            </ul>
          </div>
          {CONTACTS}
        </div>

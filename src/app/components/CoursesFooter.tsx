...
export function CoursesFooter() {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-[#1e2939] text-white pt-16 pb-8 border-t-4 border-[#40AB40]">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link to="/licenses" className="hover:text-[#40AB40] transition-colors">Сведения</Link></li>

...
import { LayoutList, Calendar, GraduationCap, Image, Star, MessageCircle, TrendingUp, DollarSign, Scissors } from 'lucide-react';
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        >
          <DollarSign className="w-10 h-10 text-[#40AB40] mb-2" />
